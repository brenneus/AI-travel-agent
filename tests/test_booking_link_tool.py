...
async def run_booking_link_test():
    print("🧪 Starting FINAL BOOKING LINK Test...")
    ...
    # This URL should be the one where the outbound is already selected, and we are looking at return list
    mock_search_url = "https://www.google.com/travel/flights/search?tfs=CBwQAho_EgoyMDI2LTAyLTEyIh8KA0pGSxIKMjAyNi0wMi0xMhoDU1JRKgJCNjIDMTYzagcIARIDSkZLcgcIARIDU1JRGh4SCjIwMjYtMDItMTZqBwgBEgNTUlFyBwgBEgNKRktAAUgBcAGCAQsI____________AZgBAQ&tfu=CmxDalJJVGtoa1dsVnZhazVLWm10QlF6aEtZbEZDUnkwdExTMHRMUzB0TFhaMGNuY3hPVUZCUVVGQlIyMUVhMEU0VDJsblVIZEJFZ1ZDTmpFMk14b0xDSXY3QkJBQ0dnTlZVMFE0SFhDTCt3UT0SAggAIgA" 
